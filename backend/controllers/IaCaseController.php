...
use backend\models\knn\IaCaseSearch;
...
/**
 * IaCaseController implements the CRUD actions for IaCase model.
 */
class IaCaseController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all IaCase models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new IaCaseSearch();
    ...
    /**
     * Displays a single IaCase model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing IaCase model.
    ...
    /**
     * Deletes an existing IaCase model.
    ...
    /**
     * Finds the IaCase model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return IaCase the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = IaCase::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    /**
    * Bulk Deletes for existing IaCase models.
    * If deletion is successful, the browser will be redirected to the 'index' page.
    * @return mixed
    */
