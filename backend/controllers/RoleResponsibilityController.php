...
use backend\models\business\RoleResponsibilitySearch;
...
/**
 * RoleResponsibilityController implements the CRUD actions for RoleResponsibility model.
 */
class RoleResponsibilityController extends Controller
{
    ...
    /**
     * Lists all RoleResponsibility models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new RoleResponsibilitySearch();
    ...
    /**
     * Displays a single RoleResponsibility model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new RoleResponsibility model.
    ...
    /**
     * Updates an existing RoleResponsibility model.
    ...
    /**
    * Bulk Deletes for existing RoleResponsibility models.
    * If deletion is successful, the browser will be redirected to the 'index' page.
    * @return mixed
    */
