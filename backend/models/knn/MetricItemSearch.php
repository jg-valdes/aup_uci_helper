...
/**
 * MetricItemSearch represents the model behind the search form of `backend\models\knn\MetricItem`.
 */
class MetricItemSearch extends MetricItem
{
    /**
     * @inheritdoc
     */
