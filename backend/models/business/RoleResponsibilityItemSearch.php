...
/**
 * RoleResponsibilityItemSearch represents the model behind the search form of `backend\models\business\RoleResponsibilityItem`.
 */
class RoleResponsibilityItemSearch extends RoleResponsibilityItem
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'role_responsibility_id', 'status'], 'integer'],
