...
/**
 * RoleResponsibilitySearch represents the model behind the search form of `backend\models\business\RoleResponsibility`.
 */
class RoleResponsibilitySearch extends RoleResponsibility
{
    /**
     * @inheritdoc
     */
