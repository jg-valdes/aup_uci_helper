...
/**
 * ProcessSearch represents the model behind the search form of `backend\models\business\Process`.
 */
class ProcessSearch extends Process
{
    ...
    {
        return [
            [['id', 'discipline_id', 'order', 'status'], 'integer'],
            [['name', 'alias', 'description', 'created_at', 'updated_at'], 'safe'],
        ];
    }
